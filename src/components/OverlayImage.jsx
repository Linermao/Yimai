  ...
  return (
    <div className="relative w-[300px] h-[200px] lg:w-[350px] lg:h-[250px] rounded-xl shadow-lg overflow-visible">
      ...
      <img
        src={overlaySrc}
        alt="叠加图"
        className={`absolute -bottom-6 -right-6 w-1/3 max-w-[120px] rounded-xl shadow-md transition-all duration-300 ease-out ${
          isHovered ? "scale-300 translate-x-4 translate-y-4" : "scale-100"
        }`}
